...
/**
 * Servlet implementation class DeletePerfromanceTrackingServlet
 */
@WebServlet("/DeletePerfromanceTrackingServlet")
public class DeletePerfromanceTrackingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeletePerfromanceTrackingServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ptservice.removePerformacneTracking(id);
