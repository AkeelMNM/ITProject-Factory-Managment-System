...
/**--------------------------   Get All Tea Grades in Tea_Greads table   -----------------------------------**/		
	...
	public ArrayList<Tea_Grades> getAllTeaGrades() 
	{
		...
		try {
			...
			preparedStatement = connection.prepareStatement(InventoryQueryUtil.queryByID(InventryComman.Query_ID_GET_ALL_TEA_GRADES));
			...
			while(result.next())
			{
				...
				TeaGrade.setTeaGrade_ID(result.getString(InventryComman.COLUMN_INDEX_ONE));
				TeaGrade.setTea_Grade_Name(result.getString(InventryComman.COLUMN_INDEX_TWO));
	...
	public String getTeaGradeName(String TeaGradeID) 
	{
		...
		if(TeaGradeID != null && !TeaGradeID.isEmpty())
		{
			try {		
				...
				preparedStatement = connection.prepareStatement(SalesQueryUtil.queryByID(InventryComman.Query_ID_GET_ALL_TEA_GRADES));
				
				preparedStatement.setString(InventryComman.COLUMN_INDEX_ONE, TeaGradeID);
