...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		<ul><li><a class="menu" href="${pageContext.request.contextPath}/Interfaces/Home/Admin_Home.jsp">Home
				<ul>
				  ...
				  <li><a class="menu" href="Inventory/InventAdmin.jsp">Tea Stock</a></li>
...
<div id="bodyDiv">
		...
		<h1 id ="top" style="background-color:#99CA36; color:white;">Update Sales Stock</h1>
				<form>
				<table id = "formTab">
					<tr><td>SalesStock Id: </td> <td><input type="text"/></td></tr>
					...
					<tr><td>Tea Grade Quantity: </td> <td><input type="text"/></td></tr>
					<br>
					<tr><td>Tea Grades: </td>
					<td><select name="grades">
					<option value = "BOP">BOP</option>
					...
					<tr><td><input type = "submit" class ="delete"value ="Delete"></td><td><input type="submit" class="sub" value="Update"></td></tr>
				</table>
