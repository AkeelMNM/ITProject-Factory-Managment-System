            ...
            function openUpdateModal(id) {
                ...
                $.getJSON("${pageContext.request.contextPath}/getSalary?salId=" + id, function (data) {
                    $(function () {
                        ...
                        $("#updatedDailyDate").val(data.date);
					 ...
					 <%if (type.equalsIgnoreCase("Daily")) {%>
                        <div id="daily">
                            ...
                            <tr>
	                            ...
	                            <td></td>
	                            <td><input class="form-control" type="date" name="dailyDate"  id="dailyDate" size="55"  onkeyup="calculateTotal1()" onkeypress="return IsNumeric(event);"></td>
	                        </tr>
                            <tr>
                    ...
                    <%
                        try {
                            ResultSet rs = DBConnection.getDBConnection().createStatement().executeQuery("SELECT * FROM employee "
                                    ...
                                    + "jobs.Salary_Payment_Methoed = 'Daily'");
                            while (rs.next()) {
                        ...
                        <form id="SalaryUpdateForm">
                            ...
                            <tr>
                             ...
                             <tr>
	                            <td><label class="col-form-label">Date</label></td>
	                            <td></td>
	                            <td><input class="form-control" type="date" name="updatedDailyDate"  id="updatedDailyDate" size="55"  onkeyup="calculateTotal3()" onkeypress="return IsNumeric(event);"></td>
	                        </tr>          
                              <tr>
                                <td> <label class="col-form-label">Insurance</label> </td>
                                <td></td>
