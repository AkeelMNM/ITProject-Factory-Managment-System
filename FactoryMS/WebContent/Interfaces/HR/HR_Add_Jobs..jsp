...
<div id="bodyDiv">
		...
		<table class="form">
				...
				<tr>
					<td>Job Title :</td>
					<td><input type="text" name="jobtitle" tabindex="1" size="55" required></td>
				</tr>
				<tr>
					<td>Creating Date : </td>
					<td><input type="date" name="date" tabindex="2"  required></td>
				</tr>
				<tr>
					<td>Basic Salary : </td>
					<td><input type="text" name="salary" tabindex="3" size="55" required ></td>
				</tr>
				<tr>
					<td>Salary Paying Method : </td>
					<td><input type="radio" name="salmethod" value="Monthly" tabindex="4" checked="checked"> Monthly
					<input type="radio" name="salmethod" value="Daily" tabindex="5" > Daily</td>
				</tr>
				<tr>
					<td>ETF Rate : </td>
					<td><input type="text" name="etf" tabindex="6" size="55" required ></td>
				</tr>
				<tr>
					<td >EPF Rate : </td>
					<td><input type="text" name="epf" tabindex="7" size="55" required></td>
				</tr>
				<tr>
					<td >Over Time Rate : </td>
					<td><input type="text" name="epf" tabindex="8" size="55" required></td>
				</tr>
